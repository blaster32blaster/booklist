...
# copy over supervisor jobs
# COPY ./dock-files/laravel-echo-server.conf /etc/supervisor/conf.d/laravel-echo-server.conf
COPY ./dock-files/laravel-queue-worker.conf /etc/supervisor/conf.d/laravel-queue-worker.conf

# copy over public files, volume not working there?
